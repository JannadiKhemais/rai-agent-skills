...
def init_tools(model: Model):
    # Workaround for v1.0.2: redirect schema cache to /tmp so it works in the Snowflake UDF sandbox,
    # which does not allow writing to the default relative 'build/cache/' path.
